...
- **disableInterpolation** (boolean) Will allow _groupTimes_ to work slightly faster by selecting approximate samples instead of interpolating and averaging them.
